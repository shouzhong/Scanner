...
public class NativeOcrJz {
    ...
    public native long SaveImageJpg(long paramLong, byte[] paramArrayOfByte);
    ...
    public native int RecYuvImg(byte[] imgData, int previewWidth, int previewHeight, int[] rect, byte[] license);
    ...
    public native long SaveImage(long paramLong1, long paramLong2, byte[] paramArrayOfByte);

    public native long GetImage(byte[] paramArrayOfByte);
